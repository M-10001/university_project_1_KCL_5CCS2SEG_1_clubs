...
# Url name for redirecting to log_in view.
LOGIN_URL = 'log_in'

# Url name for redirecting to user page view.
USER_PAGE_URL = 'user_page'

# Message level tags are set to use bootstrap terms.
MESSAGE_TAGS = {
